  ...
  processedAgesRow.map((r) => {
    byAges[r[0]] = {
      M: {
        ...
        total: [...Array(17).keys()].reduce((a, i) => a + parseInt(r[i + 1], 10), 0),
        '0-19': [...Array(4).keys()].reduce((a, i) => a + parseInt(r[i + 1], 10), 0),
        '20-59': [...Array(8).keys()].reduce((a, i) => a + parseInt(r[i + 5], 10), 0),
        '60+': [...Array(5).keys()].reduce((a, i) => a + parseInt(r[i + 13], 10), 0),
      },
      F: {
        ...
        '0-19': [...Array(4).keys()].reduce((a, i) => a + parseInt(r[i + 18], 10), 0),
        '20-59': [...Array(8).keys()].reduce((a, i) => a + parseInt(r[i + 22], 10), 0),
        '60+': [...Array(5).keys()].reduce((a, i) => a + parseInt(r[i + 30], 10), 0),
